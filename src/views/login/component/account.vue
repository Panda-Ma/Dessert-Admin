       ...
       // const data = res.data;
        if (res.code == 200) {
          const userInfos:UserInfosState = {
            ...
            userName: 'admin',
            name: '管理员',
            photo: 'https://7072-prod-4gxu6g6h60295a8a-1316819095.tcb.qcloud.la/img/0511194707127765.jpg?sign=f8ff64dad9d2f71671c07962a5aa4c1b&t=1681053226',
            roles: ['admin','common'],//data.role === 1 ? ['admin'] : ['common'],
